...
class EmployeeService:
    ...
    def create_employee(self, data: dict) -> dict:
        # Optional: prevent duplicate employee_id
        if self._repo.get_by_field("employee_id", data.get("employee_id", "")):
            raise ValueError("An employee with this employee_id already exists")
